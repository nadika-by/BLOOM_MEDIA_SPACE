...
* 📂 **[`/branding`](./branding)** — Graphical assets, logos (including Quantum Shield), and brand identity guidelines.
* 📂 **[`/integrations`](./integrations)** — Guidelines for cross-linking with `LANDORA KZ` and `Green Titans` repositories.
...
* 🌿 **Дом Творчества Nadika — Идеологический источник**
    * **Роль:** Душа и креативный код.
    * **Функция:** Главный генератор контента, смыслов и образов. Наполняет Bloom TV и Bloom FM эксклюзивной музыкой, поэзией, визуальным стилем и дизайном.

### 3. Навигация по репозиторию (Карта проекта)
* 📂 **[`/concepts`](./concepts)** — Фундаментальная документация (`bloom-tv.md`, `bloom-fm.md`, `nadika-creative-core.md`).
* 📂 **[`/branding`](./branding)** — Графические материалы, логотипы (включая Quantum Shield) и фирменный стиль.
* 📂 **[`/integrations`](./integrations)** — Инструкции по связям с репозиториями `LANDORA KZ` и `Green Titans`.
